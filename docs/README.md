...
| [SNIPPETS.md](SNIPPETS.md) | English | cort_voc ingest, kwic build, corpus overview |
| [GOLD_LABELLING.md](GOLD_LABELLING.md) | English | Gold CSV labelling workflow |
| [ANNOTATION_STRATEGY.md](ANNOTATION_STRATEGY.md) | English | **Canonical guide** — gold policy, sampling, eval, three tracks |
...
Follow [ANNOTATION_STRATEGY.md](ANNOTATION_STRATEGY.md) §4. Operational columns/UI: [GOLD_LABELLING.md](GOLD_LABELLING.md).
